...
export FLUX_DEV="/umbc/rs/pi_donengel/users/jbaker15/freegraftor/models/flux"
export GROUNDING_DINO="/umbc/rs/pi_donengel/users/jbaker15/freegraftor/models/dino"
